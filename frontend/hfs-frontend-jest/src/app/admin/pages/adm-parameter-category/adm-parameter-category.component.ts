...
@Component({
  ...
  providers: [MessageService, ExportService, AdmParameterCategoryService]
})
export class AdmParameterCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .catch((erro: ErrorResponseDTO) => {
      this.messageService.add({ severity: 'error', summary: 'Erro', detail: erro.message });
    });
  ...
  onExport() {
    this.admParameterCategoryService.report(this.reportParamForm)
    .then(() => {
  ...
  onSave() {
    ...
    if (this.admParameterCategory.description.trim()) {
        if (this.admParameterCategory.id) {
          this.admParameterCategoryService.update(this.admParameterCategory)
          .then((obj: AdmParameterCategory) => {
          ...
          this.admParameterCategoryService.insert(this.admParameterCategory)
          .then((obj: AdmParameterCategory) => {
            this.admParameterCategory = obj;
