        ...
        <div className="grid">
            <div className="col-12">
                <div className="card px-6 py-6">
                        ...
                        <div className="grid">
                            <div className="col-4">
                                <button className="p-link w-4rem h-2rem" onClick={() => _changeTheme('lara-light-indigo', 'light')}>
                                    <i className="pi pi-sun" style={{ fontSize: '2rem' }}></i>
                                </button>
                                <button className="p-link w-4rem h-2rem" onClick={() => _changeTheme('lara-dark-indigo', 'dark')}>
