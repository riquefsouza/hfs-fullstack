...
<template>
    ...
    <Sidebar v-model:visible="visible" position="right" :transitionOptions="'.3s cubic-bezier(0, 0, 0.2, 1)'" class="layout-config-sidebar w-20rem">
        ...
        <div class="grid">
            <div class="col-2">
                <button class="p-link w-4rem h-2rem" @click="onChangeTheme('lara-light-indigo', 'light')">
                    <i class="pi pi-sun" style="font-size: 2rem"></i>
                </button>
                <button class="p-link w-4rem h-2rem" @click="onChangeTheme('lara-dark-indigo', 'dark')">
